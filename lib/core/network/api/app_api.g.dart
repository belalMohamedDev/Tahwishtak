...
class _AppServiceClient implements AppServiceClient {
  ...
  @override
  Future<AuthResponse> loginService(LoginRequest loginRequest) async {
  ...
  @override
  Future<AuthResponse> signUpService(RegisterRequest registerRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<AddActivityModel> addActivityService(
    ...
    final _options = _setStreamType<AddActivityModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/api/dailyActivity',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddActivityModel _value;
    try {
      _value = AddActivityModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<TodayActivitiesModel> startNewDayService(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(startNewDayRequest.toJson());
    final _options = _setStreamType<TodayActivitiesModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/api/dailyActivity/newDays',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
